...
def test_update_task_replaces_task_data(client, create_task, parse_response):
    ...
    Flow:
    1. Create a task
    2. Update it with PUT
    3. Validate the updated values
    """
    ...
    payload = {"title": updated_title, "description": updated_description, "due_date": None}
...
def test_update_task_returns_404_when_task_does_not_exist(client):
    ...
    # Arrange
    non_existing_id = 999
    payload = {"title": "Updated title","description": "updated","due_date": None}
